...
def gen_last_seen_table(n_clicks):
    npp_data = sdr_subscriber.sdrs.loc[sdr_subscriber.sdrs["platform_name"] == "Suomi-NPP"]
    j01_data = sdr_subscriber.sdrs.loc[sdr_subscriber.sdrs["platform_name"] == "NOAA-20"]
